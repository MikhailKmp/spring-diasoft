...
class QuestionServiceTest {
    ...
    void constructorShouldCreateQuestions() throws IOException {
        QuestionService questionService = new QuestionService("src/test/resources/questions.csv");
    ...
    void constructorShouldThrowExceptionWhenFormatIsInvalid() {
        assertThrows(IllegalArgumentException.class, () -> new QuestionService("src/test/resources/questionsError.csv"));
    }
