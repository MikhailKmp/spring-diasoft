...
public class DiagnosticsService {
    ...
    public DiagnosticsService(@Value("${questions.answers.correct.required.number}") Integer requiredNumberCorrectAnswers,
     ...
     * Запуск тестирования
     */
    public void runTest(List<Question> questions, Scanner scanner) {
