...
class DiagnosticsServiceTest {
    ...
    void consoleOutputWhenTestPassed() {
        ...
        DiagnosticsService diagnosticsService = new DiagnosticsService(1, messageSource);

        Locale.setDefault(Locale.forLanguageTag(Locales.RU));
        try (Scanner scanner = new Scanner(in)) {
            diagnosticsService.runTest(List.of(question), scanner);
    ...
    void consoleOutputWhenTestFail() {
        ...
        DiagnosticsService diagnosticsService = new DiagnosticsService(2, messageSource);

        Locale.setDefault(Locale.forLanguageTag(Locales.RU));
        try (Scanner scanner = new Scanner(in)) {
            diagnosticsService.runTest(List.of(question1, question2), scanner);
